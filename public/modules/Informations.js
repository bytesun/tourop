define([
    ...
    var InformationsModule = app.module("Informations", function(Informations) {
    	
    	Informations.Model = Backbone.Model.extend({
     	       urlRoot: '/api/infos',
   	       idAttribute: '_id',
   	       defaults:{
   	    	 code:"H001",
    	...
    	Informations.Collection = Backbone.Collection.extend({
    	      url: '/api/infos',
    	...
    	var API = {
    		getInformations:function(){
    			...
    			var infos = new Informations.Collection();
    			var defer = $.Deferred();
    			infos.fetch({
    		...
    		getInformation:function(id){
    			var info = new Informations.Model({'_id':id});
    			var defer = $.Deferred();
    			//setTimeout(function(){
    				info.fetch({
    					success:function(data){
